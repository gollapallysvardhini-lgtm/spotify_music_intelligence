...
def generate_sample_data(n_samples=500):
    ...
    # Real song names for better searchability
    song_names = [
        "Blinding Lights", "Shape of You", "Dance Monkey", "Someone You Loved", "Bad Guy",
        "Watermelon Sugar", "Levitating", "Stay", "As It Was", "Heat Waves",
        "drivers license", "Peaches", "Good 4 U", "Montero", "Kiss Me More",
        "Industry Baby", "Butter", "Save Your Tears", "Peaches", "STAY",
        "Shivers", "My Universe", "Easy On Me", "Cold Heart", "ABCDEFU",
        "Enemy", "Beggin'", "Woman", "Need to Know", "INDUSTRY BABY"
    ]
    
    data = {
        "track_name": [song_names[i % len(song_names)] for i in range(n_samples)],
